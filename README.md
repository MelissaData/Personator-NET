...
This is a sample code for Melissa's Personator API. It is written in C# and accesses the API through REST. 
This sample is intended to show the functionality of the Personator Web Service and how to call the service in C#. 
